...
struct fp_messages {
    ...
    const char *matched_pending, *ready, *retry, *ended, *unavailable, *authenticated;
};
...
static const struct fp_messages fp_catalog[] = {
    {"en", "[Admin Auth] Password: ", "[Admin Auth] Password (input is hidden):\n",
     ...
     "[Fingerprint] Matched. Enter to finish.", "[Fingerprint] Touch sensor.",
    ...
    {"es", "[Aut. admin] Contraseña: ", "[Aut. admin] Contraseña (entrada oculta):\n",
     ...
     "[Huella] Coincide. Pulse Enter.", "[Huella] Ponga el dedo.",
    ...
    {"de", "[Admin-Anmeldung] Passwort: ", "[Admin-Anmeldung] Passwort (Eingabe verborgen):\n",
     ...
     "[Fingerabdruck] Erkannt. Enter drücken.", "[Fingerabdruck] Finger auflegen.",
    ...
    {"fr", "[Auth. admin] Mot de passe : ", "[Auth. admin] Mot de passe (saisie masquée) :\n",
     ...
     "[Empreinte] Reconnue. Appuyez sur Entrée.", "[Empreinte] Posez le doigt.",
    ...
    {"ru", "[Администратор] Пароль: ", "[Администратор] Пароль (ввод скрыт):\n",
     ...
     "[Отпечаток] Совпадение. Нажмите Enter.", "[Отпечаток] Приложите палец.",
    ...
    {"it", "[Aut. admin] Password: ", "[Aut. admin] Password (digitazione nascosta):\n",
     ...
     "[Impronta] Corrisponde. Premere Invio.", "[Impronta] Appoggiare il dito.",
    ...
    {"pt", "[Aut. admin] Palavra-passe: ", "[Aut. admin] Palavra-passe (entrada oculta):\n",
     ...
     "[Impressão digital] Corresponde. Prima Enter.", "[Impressão digital] Coloque o dedo.",
